            ...
            <div className="space-y-3">
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  <option value="rainbow" disabled style={{ color: '#9ca3af' }}>Rainbow Foil (Coming Soon)</option>
                  <option value="gloss" disabled style={{ color: '#9ca3af' }}>Piano Gloss (Coming Soon)</option>
                  <option value="silver" disabled style={{ color: '#9ca3af' }}>Spot Silver (Coming Soon)</option>
                  <option value="silver-rainbow" disabled style={{ color: '#9ca3af' }}>Spot Silver + Rainbow (Coming Soon)</option>
                  <option value="silver-gloss" disabled style={{ color: '#9ca3af' }}>Spot Silver + Gloss (Coming Soon)</option>
                </select>
              </div>
            </div>
