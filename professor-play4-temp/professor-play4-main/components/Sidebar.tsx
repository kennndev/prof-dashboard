...
import { ImagePlus, List, FileCode, Crop, Copy, ArrowRight, Scissors, RotateCcw, CheckCircle, AlertTriangle, X, Megaphone, ExternalLink } from 'lucide-react'
    ...
    for (let i = 0; i < total; i++) {
      ...
      await new Promise<void>((resolve) => {
        ...
        reader.onload = (e) => {
          ...
          const cardBleed = card.bleedMm !== undefined ? card.bleedMm : 1.9
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-blue-700 dark:text-blue-300 mb-1">
                          Action Required: Add Bleed
                        </h4>
                        <p className="text-xs text-slate-600 dark:text-slate-300 mb-3 leading-relaxed">
                          To ensure a professional result, you <span className="font-bold">must add 1.9mm of bleed</span> to your images.
                        </p>
                        <div className="bg-white dark:bg-slate-900/50 rounded p-2 mb-3 border border-blue-100 dark:border-blue-800/50">
                          <ol className="list-decimal list-inside text-xs text-slate-600 dark:text-slate-300 space-y-1.5 ml-1">
                            ...
                            <li>Click <strong className="text-blue-600 dark:text-blue-400">Add Bleed</strong></li>
                            <li>Adjust <strong className="text-slate-800 dark:text-slate-200">Corner Trim</strong> to remove white corners</li>
                            <li>Click <strong className="text-slate-800 dark:text-slate-200">Apply to All Cards</strong></li>
                            <li className="font-bold text-amber-600 dark:text-amber-500 pt-1 border-t border-slate-100 dark:border-slate-800 mt-1">Check visually: Cycle through every card to ensure corners are not with defects!</li>
                          </ol>
                        </div>
          ...
          {currentStep === 2 && deck.length > 0 && (
            <div className="p-4 sm:p-6 border-t border-slate-200 dark:border-slate-800 bg-purple-50/50 dark:bg-slate-850">
              ...
              {sequentialProcessing ? (
                ...
                <button
                  onClick={() => sequentialBacksInputRef.current?.click()}
      ...
      <div className="space-y-4">
        ...
        <div className="bg-blue-100/50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded p-2.5 space-y-2">
          ...
          <div className="flex gap-2 items-start pt-1 border-t border-blue-200 dark:border-blue-800">
            ...
            <p className="text-[10px] leading-tight text-slate-600 dark:text-slate-400">
              <strong className="text-slate-800 dark:text-slate-200">3mm bleed added (-1.25mm):</strong> These images often have large bleeds. Set adjustment to <strong>-1.25mm</strong> to trim them to our spec.
            </p>
          </div>
        </div>
